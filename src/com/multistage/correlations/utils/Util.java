...
public final class Util {
	...
	/**
	 * Calculates the X and Y coordinates that a child component should have to
	 * be centered within its parent. This method does not try to constrain the
	 * calculation so that the point remains wholly onscreen.
	 * 
	 * @param rec
	 ...
	 * @return String
	 */
	public static String substituteText(String text, String token,
			String substitute) {
		int index;
	 ...
	 * masked expressions. The returned string is displayable in html
	 ...
	 * of the input file. The output file will be overwritten if it exist. A
	 * CRC32 check is performed to compare source and copy after the copy
	 * process and if results negative a <code>StreamCorruptedException</code>
	 * is thrown. Function reports errors to <code>System.err</code>.
	 * 
	 * @param inputFile
	 *            a File object
	 * @param outputFile
	 ...
	 *             if the function could not be completed because of an IO or
	 *             CRC check error
	 */
	 ...
	 * specification of parameter <code>file</code>. If the specified file is
	 * a relative path, it is made absolute against <code>defaultDir</code>.
	 * If <code>defaultDir</code> is <b>null</b> the System property
	 * "user.dir" is assumed as default directory.
	 * 
	 * @return <b>true</b> if and only if the parent directory of the specified
	 *         file exists after this function terminates
	 */
	 ...
	 * 
	 * @param dir
	 *            File specifying the intended directory; if the specified path
	 *            is a relative path, it is made absolute against
	 *            <code>defaultDir</code>. If <code>defaultDir</code> is
	 *            <b>null</b> the System directory "user.dir" is assumed as
	 *            default.
	 * @return <b>true</b> if and only if the specified file exists and is a
	 *         directory after this function terminates
	 */
	public static boolean ensureDirectory(File dir, File defaultDir) {
		...
		if (!dir.isDirectory()) {
			...
			if (!success)
				System.err.println("failed while trying to create directory: "
						+ dir.toString());
		}
