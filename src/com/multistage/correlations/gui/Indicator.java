...
public class Indicator extends JFrame {
  ...
  public Indicator() {
    super("CheckListIndicator");
    String[] strs = {};
    
    
    strs = listPath(new File("data/tmp"));

    //strs[strs.length] = SetEnv.INIFILE;
  ...
  public static void main(String args[]) {
    ...
    frame.setPreferredSize(new Dimension(SetEnv.SizeB,
			(int) (0.26 * SetEnv.SizeY)));
