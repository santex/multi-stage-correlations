...
import harmonic.cad.shapes.RegionShape;
...
public class FibonocciRectangles extends Module{
	IntField count = new IntField("count", 5);

	public FibonocciRectangles(){
	...
	public void fib(int n){
		...
		*/
		...
		for (int i = 1; i < n; i++){
			...
			RegionShape region = new RegionShape(className);//cad.region(def);
